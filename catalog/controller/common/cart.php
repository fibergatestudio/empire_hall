...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		if ($count_prods == 1) {
		    $data['header_items'] = sprintf($this->language->get('text_items1'), $count_prods);
        } elseif ($count_prods > 1 && $count_prods < 5) {
            $data['header_items'] = sprintf($this->language->get('text_items4'), $count_prods);
        } else {
            $data['header_items'] = sprintf($this->language->get('text_items5'), $count_prods);
        }
		...
		$data['checkout'] = $this->url->link('checkout/step2checkout', '', true);
