...
$_['text_instock'] = 'в наявності %s шт';
$_['text_outstock'] = 'під замовлення';
$_['text_tax'] = 'Без ПДВ:';
...
$_['text_month'] = 'місяць';
$_['text_year'] = 'рік';
$_['text_preorder_no_price']            = 'Під замовлення';
$_['text_get_price'] = 'Дізнатись ціну';
$_['text_all_combinations'] = 'Дивитися всі товари';
$_['text_product_txt_price'] = 'Ціну уточняйте у менеджера, в вашому списку товарів є товари без ціни';
$_['text_product_txt_price2'] = 'Ціну уточняйте у менеджера.';

$_['button_cart_txt'] = 'Додати до кошика';
