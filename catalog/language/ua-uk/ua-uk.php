...
$_['text_to_catalog'] = 'До магазину';
$_['text_pagination_prev'] = 'Попередня';
$_['text_pagination_last'] = 'Наступна';
$_['text_read_all'] = 'Читайте також';
$_['text_see_all']  = 'Дивитися всі новини';
$_['text_no_price'] = 'Дізнатись ціну';
$_['text_popular_brand'] = 'Популярні бренди';
$_['text_more_btn'] = 'Детальніше';
$_['text_active_filters'] = 'Aктивні фільтри';
$_['text_product_title']  = 'Дізнатись ціну';
$_['count_resault']    = 'Знайдено: <span>%s товару </span>';
...
$_['button_compare_already']= 'Товар в порівнянні';
$_['button_wishlist'] = 'В закладки';
$_['button_wishlist_already']= 'Товар в закладках';
...
$_['button_result_search']            = 'Показати всі результати ';
...
$_['error_email_newsleter']            = 'Email хибний!';
$_['error_email_check_newsleter']            = 'Цей Email вже підписаний!';


$_['text_title_popup_home']   = 'Empire Hall collections 2019';
$_['text_description_popup_home']   = 'Ми створюємо прикраси для тих, хто не боїться бути собою і вміє діяти рішуче.';

$_['text_no_price']         = 'Немає ціни';
$_['text_get_price'] = 'Дізнатись ціну';