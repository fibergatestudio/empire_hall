...
class ModelAccountCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "',`birthday`='".$data['date']."', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', zone_id = '" . $this->db->escape($data['zone_id']) . "', city_id = '" . $this->db->escape($data['city_id']) . "', street = '" . $this->db->escape($data['street']) . "', room = '" . $this->db->escape($data['room']) . "', house = '" . $this->db->escape($data['house']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']['account']) ? json_encode($data['custom_field']['account']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
	}
    ...
    public function getPdfCatalogs() {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "download d LEFT JOIN " . DB_PREFIX . "download_description dd ON(d.download_id=dd.download_id) AND dd.language_id = '" . (int)$this->config->get('config_language_id')."'");
