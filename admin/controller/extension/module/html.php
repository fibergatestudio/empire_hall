...
class ControllerExtensionModuleHTML extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['product_desc_img'])) {
			$data['product_desc_img'] = $this->request->post['product_desc_img'];
		} elseif (isset($this->request->get['module_id'])) {
			$data['product_desc_img'] = $this->model_setting_module->getHtmlTrigger($this->request->get['module_id']);
		} else {
			$data['product_desc_img'] = array();
		}		
		
		$data['pdi_count'] = array();
		
		foreach ($data['languages'] as $language) { 
			
			if(isset($data['product_desc_img'][$language['language_id']])){
				$data['pdi_count'][$language['language_id']] = count($data['product_desc_img'][$language['language_id']]);
			}
		}
