...
//					'href'     => $this->url->link('catalog/promotags', 'user_token=' . $this->session->data['user_token'], true),
//					'children' => array()
//				);
//			}
...
//			$map = array();
//
//			if ($this->user->hasPermission('access', 'catalog/storestockcity')) {
//				$map[] = array(
//					'name'     => $this->language->get('text_storestockcity'),
//					'href'     => $this->url->link('catalog/storestockcity', 'user_token=' . $this->session->data['user_token'], true),
//					'children' => array()
//				);
//			}
//
//			if ($this->user->hasPermission('access', 'catalog/storestock')) {
//				$map[] = array(
//					'name'	   => $this->language->get('text_storestock'),
//					'href'     => $this->url->link('catalog/storestock', 'user_token=' . $this->session->data['user_token'], true),
//					'children' => array()
//				);
//			}
//
...
//			if ($this->user->hasPermission('access', 'catalog/kcf')) {
//				$catalog[] = array(
//					'name'	   => $this->language->get('text_kcf'),
//					'href'     => $this->url->link('catalog/kcf', 'user_token=' . $this->session->data['user_token'], true),
//					'children' => array()
//				);
//			}

//			if($this->config->get('module_faq_status')){
...
//            );
           ...
           // }
            ...
            $collections[] = array(
                'name'     => $this->language->get('text_collection_category'),
                'href'     => $this->url->link('catalog/collection', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );

            $collections[] = array(
                'name'	   => $this->language->get('text_collection'),
                'href'     => $this->url->link('catalog/collection_item', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            ...
            if ($this->user->hasPermission('access', 'catalog/inspiration')) {
                $data['menus'][] = array(
                    'id'       => 'menu-pages',
                    'icon'	   => 'fa-book',
                    'name'	   => $this->language->get('text_inspiration'),
                    'href'     => $this->url->link('catalog/inspiration', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
...
//            if ($this->user->hasPermission('access', 'catalog/menu_header')) {
//                $design[] = array(
//                    'name'	   => $this->language->get('text_topmenu'),
//                    'href'     => $this->url->link('catalog/menu_header', 'user_token=' . $this->session->data['user_token'], true),
//                    'children' => array()
//                );
//            }
            ...
            if ($this->user->hasPermission('access', 'catalog/menu')) {
                $design[] = array(
                    'name'	   => $this->language->get('text_bottommenu'),
