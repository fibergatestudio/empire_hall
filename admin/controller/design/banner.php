...
class ControllerDesignBanner extends Controller {
	...
	public function index() {
        ...
        //$this->model_design_banner->addSmImageCol(); //temp
        //$this->model_design_banner->addMdImageCol(); //temp
        //$this->model_design_banner->addLgImageCol(); //temp
	...
	protected function getForm() {
		...
		foreach ($banner_images as $key => $value) {
			foreach ($value as $banner_image) {
                ...
                if (is_file(DIR_IMAGE . $banner_image['image_md'])) {
                    $image_md = $banner_image['image_md'];
                    $thumb_md = $banner_image['image_md'];
                } else {
                    $image_md = '';
                    $thumb_md = 'no_image.png';
                }

                if (is_file(DIR_IMAGE . $banner_image['image_lg'])) {
                    $image_lg = $banner_image['image_lg'];
                    $thumb_lg = $banner_image['image_lg'];
                } else {
                    $image_lg = '';
                    $thumb_lg = 'no_image.png';
                }
				...
				$data['banner_images'][$key][] = array(
					...
					'thumb_md'      => $this->model_tool_image->resize($thumb_md, 100, 100),
					'thumb_lg'      => $this->model_tool_image->resize($thumb_lg, 100, 100),
