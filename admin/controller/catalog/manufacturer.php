...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		} elseif (!empty($manufacturer_info) && is_file(DIR_IMAGE . $manufacturer_info['image3'])) {
			$data['thumb3'] = $this->model_tool_image->resize($manufacturer_info['image3'], 100, 100);
		} else {
		...
		if (isset($this->request->post['hide_price'])) {
			...
			$data['hide_price'] = $manufacturer_info['hide_price'];
		} else {
			$data['hide_price'] = '';
		}
