...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_og_title'])) {
			$data['config_og_title'] = $this->request->post['config_og_title'];
		} else {
			$data['config_og_title'] = $this->config->get('config_og_title');
		}

		if (isset($this->request->post['config_og_desc'])) {
			$data['config_og_desc'] = $this->request->post['config_og_desc'];
		} else {
			$data['config_og_desc'] = $this->config->get('config_og_desc');
		}

        //Brands SEO-----------------------------------------------------------------

        if (isset($this->request->post['config_brands_title'])) {
            $data['config_brands_title'] = $this->request->post['config_brands_title'];
        } else {
            $data['config_brands_title'] = $this->config->get('config_brands_title');
        }

        if (isset($this->request->post['config_brands_desc'])) {
            $data['config_brands_desc'] = $this->request->post['config_brands_desc'];
        } else {
            $data['config_brands_desc'] = $this->config->get('config_brands_desc');
        }

        if (isset($this->request->post['config_brands_h1'])) {
            $data['config_brands_h1'] = $this->request->post['config_brands_h1'];
        } else {
            $data['config_brands_h1'] = $this->config->get('config_brands_h1');
        }

        $this->load->model('catalog/category');


        if (isset($this->request->post['config_exclude_category'])) {
            $categories  = $this->request->post['config_exclude_category'];
        } else {
            $categories  = $this->config->get('config_exclude_category');
        }
		...
		if (isset($this->request->post['config_about_text'])) {
			$data['config_about_text'] = $this->request->post['config_about_text'];
		} else {
			$data['config_about_text'] = $this->config->get('config_about_text');
		}
		...
		if (isset($this->request->post['config_og_image'])) {
			$data['config_og_image'] = $this->request->post['config_og_image'];
		} else {
			$data['config_og_image'] = $this->config->get('config_og_image');
		}


		if (isset($this->request->post['config_og_image']) && is_file(DIR_IMAGE . $this->request->post['config_og_image'])) {
			$data['ogthumb'] = $this->model_tool_image->resize($this->request->post['config_og_image'], 100, 100);
		} elseif ($this->config->get('config_og_image') && is_file(DIR_IMAGE . $this->config->get('config_og_image'))) {
			$data['ogthumb'] = $this->model_tool_image->resize($this->config->get('config_og_image'), 100, 100);
		} else {
			$data['ogthumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_inspiration_subtitle'])) {
			$data['config_inspiration_subtitle'] = $this->request->post['config_inspiration_subtitle'];
		} else {
			$data['config_inspiration_subtitle'] = $this->config->get('config_inspiration_subtitle');
		}

		if (isset($this->request->post['config_inspiration_text'])) {
			$data['config_inspiration_text'] = $this->request->post['config_inspiration_text'];
		} else {
			$data['config_inspiration_text'] = $this->config->get('config_inspiration_text');
		}
