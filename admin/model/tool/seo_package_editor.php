  ...
  /**
	...
	public function simple ( $request, $type, $lang, $store = 0, $columns )
	{
      ...
      if ($type == 'manufacturer') {
        $select_cols = str_replace('`d`.`name`', 'COALESCE(NULLIF(d.`name`,\'\'), id.`name`) as name', $select_cols); //custom code
        ...
        //custom code:
        $table = "`" . DB_PREFIX . $type . "` i LEFT JOIN `" . DB_PREFIX . "seo_" . $type . "_description` d ON (i.".$type."_id = d.".$type."_id AND d.store_id = '". (int) $store . "' AND d.language_id = '". (int) $lang ."') LEFT JOIN " . DB_PREFIX . $type ."_description id ON (i.".$type."_id = id.".$type."_id AND id.language_id = '". (int) $lang ."') LEFT JOIN " . DB_PREFIX . $type . "_to_store i2s ON (i.".$type."_id = i2s.".$type."_id)";
        ...
        $this->filter_language = false;
          ...
          //custom code:
          $table = '`'.DB_PREFIX . "seo_" . $type . "_description` d INNER JOIN `" . DB_PREFIX . $type . "` i ON (i.".$type."_id = d.".$type."_id AND d.store_id = '". (int) $store . "') LEFT JOIN " . DB_PREFIX . $type ."_description id ON (i.".$type."_id = id.".$type."_id AND id.language_id = '". (int) $lang ."') LEFT JOIN " . DB_PREFIX . $type . "_to_store i2s ON (i.".$type."_id = i2s.".$type."_id)";
