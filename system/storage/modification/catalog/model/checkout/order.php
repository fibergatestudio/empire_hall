...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
        ...
        /** EET Module */
		if ($this->config->get('module_ee_tracking_status') && $this->config->get('module_ee_tracking_transaction_status') && file_exists(DIR_APPLICATION . 'model/extension/module/ee_tracking.php')) {
	...
	public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		...
		if ($order_info) {
            ...
            /** EET Module */
			if (file_exists(DIR_APPLICATION . 'model/extension/module/ee_tracking.php') && $this->config->get('module_ee_tracking_status') && $this->config->get('module_ee_tracking_transaction_status') || $this->config->get('module_ee_tracking_refund_status')) {
				$this->load->model('extension/module/ee_tracking');
