...
class ControllerAccountReturn extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			/** EET Module */
			if ($this->config->get('module_ee_tracking_status') && $this->config->get('module_ee_tracking_refund_status') && $this->config->get('module_ee_tracking_customer_refund') && isset($this->request->post['order_id'])) {
