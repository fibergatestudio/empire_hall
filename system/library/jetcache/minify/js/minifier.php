<?php
/*
 * This file is part of the jc_JShrink package.
 *
...
namespace jc_JShrink;

/**
 * jc_Minifier
 *
 * Usage - jc_Minifier::minify($js);
 * Usage - jc_Minifier::minify($js, $options);
 * Usage - jc_Minifier::minify($js, array('flaggedComments' => false));
 *
 * @package jc_JShrink
 * @author Robert Hafner <tedivm@tedivm.com>
