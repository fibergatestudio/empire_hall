<?php
/**
 * Class jc_Minify_CSS_UriRewriter
 * @package Minify
 */
...
class jc_Minify_CSS_UriRewriter
{
     ...
     *
     * <code>
     * jc_Minify_CSS_UriRewriter::rewriteRelative(
     *       '../img/hello.gif'
     ...
     * if you extend jc_Minify_CSS_UriRewriter
     *
     * @var string
     */
    protected static $className = 'jc_Minify_CSS_UriRewriter';
